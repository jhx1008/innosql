...
-- Create slow_log
CREATE TABLE IF NOT EXISTS slow_log (start_time TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), user_host MEDIUMTEXT NOT NULL, query_time TIME(6) NOT NULL, lock_time TIME(6) NOT NULL, rows_sent INTEGER NOT NULL, rows_examined INTEGER NOT NULL, logical_reads INTEGER NOT NULL, physical_reads INTEGER NOT NULL, db VARCHAR(512) NOT NULL, last_insert_id INTEGER NOT NULL, insert_id INTEGER NOT NULL, server_id INTEGER UNSIGNED NOT NULL, sql_text MEDIUMBLOB NOT NULL, thread_id BIGINT(21) UNSIGNED NOT NULL) engine=MyISAM CHARACTER SET utf8 comment="Slow log";
...
CREATE TABLE IF NOT EXISTS sql_stats (START_TIME BIGINT UNSIGNED NOT NULL DEFAULT '0',END_TIME BIGINT UNSIGNED NOT NULL DEFAULT '0',SQL_TEXT VARCHAR(10240) NOT NULL DEFAULT '',DB_NAME VARCHAR(32) NOT NULL DEFAULT '', SQL_MD5 VARCHAR(16) NOT NULL DEFAULT '',INDEX_INFO VARCHAR(1024) NOT NULL DEFAULT '',MEMORY_TEMP_TABLES INT NOT NULL DEFAULT '0',DISK_TEMP_TABLES INT NOT NULL DEFAULT '0',ROW_READS BIGINT NOT NULL DEFAULT '0',BYTE_READS BIGINT NOT NULL DEFAULT '0',MAX_EXEC_TIMES BIGINT NOT NULL DEFAULT '0',MIN_EXEC_TIMES BIGINT NOT NULL DEFAULT '0',EXEC_TIMES BIGINT NOT NULL DEFAULT '0',EXEC_COUNT INT NOT NULL DEFAULT '0',PRIMARY KEY (START_TIME, END_TIME, SQL_MD5)) ENGINE=MyISAM  CHARACTER SET utf8 COLLATE utf8_bin   comment='SQL stats';

CREATE TABLE IF NOT EXISTS table_stats (START_TIME BIGINT UNSIGNED NOT NULL DEFAULT '0',END_TIME BIGINT UNSIGNED NOT NULL DEFAULT '0', DBNAME VARCHAR(64) NOT NULL DEFAULT '',TABLE_NAME VARCHAR(64) NOT NULL DEFAULT '', SELECT_COUNT BIGINT NOT NULL DEFAULT '0', INSERT_COUNT BIGINT NOT NULL DEFAULT '0',UPDATE_COUNT BIGINT NOT NULL DEFAULT '0', DELETE_COUNT INT NOT NULL DEFAULT '0',PRIMARY KEY (START_TIME, END_TIME, DBNAME,TABLE_NAME)) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_bin   comment='Table stats';
